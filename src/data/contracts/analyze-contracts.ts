...
export type PriceSnapshot = {
  ...
  asOf: string;
  sourceUsed: 'coinmarketcap' | 'market_unavailable';
  degraded: boolean;
...
export type NewsSnapshot = {
  items: NewsItem[];
  asOf: string;
  sourceUsed: 'messari' | 'news_unavailable';
  degraded: boolean;
  degradeReason?: string;
};
...
export type TokenomicsConflict = {
  field: string;
  chosenSource: 'tokenomist';
  droppedSource: 'tokenomist';
  reason: string;
};
...
export type TechnicalSnapshot = {
  ...
  asOf: string;
  sourceUsed: 'coinmarketcap' | 'technical_unavailable';
  degraded: boolean;
  degradeReason?: string;
};
...
export type SecuritySnapshot = {
  ...
  asOf: string;
  sourceUsed: 'blockaid' | 'security_unavailable';
  degraded: boolean;
  degradeReason?: string;
};
...
export type LiquiditySnapshot = {
  ...
  warnings: string[];
  asOf: string;
  sourceUsed: 'cmc_dex' | 'liquidity_unavailable';
  degraded: boolean;
  degradeReason?: string;
};
