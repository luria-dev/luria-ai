...
describe('ReportNodeService', () => {
  ...
  it('should produce a readable report body from fallback data', async () => {
      ...
      execution: {
        ...
        data: {
          ...
          fundamentals: {
            ...
            team: [],
            investors: [
              { name: 'BlackRock', type: 'institution', logoUrl: null },
              { name: 'ARK Invest', type: 'institution', logoUrl: null },
            ],
            fundraising: [
              {
                round: 'Institutional vehicle',
                amountUsd: 250000000,
                valuationUsd: null,
                publishedAt: '2026-03-01',
                investors: ['BlackRock', 'ARK Invest'],
              },
            ],
            ecosystems: {
              ecosystems: ['Store of Value'],
              onMainNet: ['ETF rails'],
              onTestNet: [],
              planToLaunch: [],
            },
            ...
            topVenues: [
              {
                ...
                pairLabel: 'BTC/USDT',
                quoteToken: 'USDT',
                liquidityUsd: 2801365473,
                volume24hUsd: 2801365473,
                priceImpact1kPct: 0.01,
                marketSharePct: 35.78,
                sourceId: 'binance',
              },
            ],
            primaryVenue: {
    ...
    expect(result.body).toContain('BlackRock');
